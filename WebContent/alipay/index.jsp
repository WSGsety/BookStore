		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" readonly="readonly" style="outline:none;" />
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" readonly="readonly" style="outline:none;" />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
					...
					%>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="<%=WIDtotal_amount %>" readonly="readonly" style="outline:none;" />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" readonly="readonly" style="outline:none;" />
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "在线书城";
		document.getElementById("WIDbody").value = "在线书城"+sNow;
